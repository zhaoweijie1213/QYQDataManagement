...
{
    [Authorize(Policy = DataManagementPermissions.IdentityServer.IdentityResources.Default)]
    public class IdentityResourceAppService : DataManagementAppService, IIdentityResourceAppService
    {
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(Policy = DataManagementPermissions.IdentityServer.IdentityResources.Create)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(Policy = DataManagementPermissions.IdentityServer.IdentityResources.Update)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(Policy = DataManagementPermissions.IdentityServer.IdentityResources.Delete)]
