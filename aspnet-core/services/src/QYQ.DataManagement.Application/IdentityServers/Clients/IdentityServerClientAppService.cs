...
namespace QYQ.DataManagement.IdentityServers.Clients
{
    [Authorize(Policy = DataManagementPermissions.IdentityServer.Client.Default)]
    public class IdentityServerClientAppService : DataManagementAppService, IIdentityServerClientAppService
    {
        ...
        /// <returns></returns>
        [Authorize(Policy = DataManagementPermissions.IdentityServer.Client.Create)]
        ...
        /// </summary>
        /// <returns></returns>
        [Authorize(Policy = DataManagementPermissions.IdentityServer.Client.Delete)]
        ...
        /// </summary>
        /// <returns></returns>
        [Authorize(Policy = DataManagementPermissions.IdentityServer.Client.Update)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(Policy = DataManagementPermissions.IdentityServer.Client.Enable)]
