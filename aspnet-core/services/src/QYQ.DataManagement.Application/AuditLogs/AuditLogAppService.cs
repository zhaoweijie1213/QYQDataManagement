...
namespace QYQ.DataManagement.AuditLogs
{
    [Authorize(Policy = DataManagementPermissions.SystemManagement.AuditLog)]
    public class AuditLogAppService : DataManagementAppService, IAuditLogAppService
    {
