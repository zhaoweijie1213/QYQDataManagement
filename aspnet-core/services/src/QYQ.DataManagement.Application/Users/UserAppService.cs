...
namespace QYQ.DataManagement.Users
{
    ...
    public class UserAppService : DataManagementAppService, IUserAppService
    {
        ...
        /// </summary>
        /// <returns></returns>
        [Authorize(DataManagementPermissions.SystemManagement.UserExport)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(DataManagementPermissions.SystemManagement.UserEnable)]
