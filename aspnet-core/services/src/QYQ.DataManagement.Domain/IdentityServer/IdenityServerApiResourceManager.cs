...
using QYQ.DataManagement.Extension.System;
using Volo.Abp;
using Volo.Abp.IdentityServer.ApiResources;
using IdentityModel;

namespace QYQ.DataManagement.IdentityServer
{
    public class IdenityServerApiResourceManager : DataManagementDomainService
    {
