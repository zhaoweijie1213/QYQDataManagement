...
using System.Linq;
using QYQ.DataManagement.Extension.Customs;
using QYQ.DataManagement.NotificationManagement.Notifications.DistributedEvents;
using QYQ.DataManagement.NotificationManagement.Notifications.Enums;
using QYQ.DataManagement.NotificationManagement.Notifications.MaxLengths;
using Volo.Abp.Domain.Entities.Auditing;

namespace QYQ.DataManagement.NotificationManagement.Notifications.Aggregates
{
    /// <summary>
    /// 消息通知 
    /// </summary>
